            ...
            <div className="w-full h-full relative flex justify-start items-center">
                        ...
                        headerData.headerMenu && headerData.headerMenu.map((item) => (
                            <Link href={item.link || ''} key={item.id} className="w-full menu-item h-[14.2857142857%] group relative flex justify-between items-center padding-main cursor-pointer">
                                <div className="flex justify-start items-center gap-[8px] opacity-0 menu-item-text">
                                    ...
                                    <p className={`text-5xl group-hover:translate-x-4 duration-200 translate-y-[6px] uppercase ${PPFragment.className}`}> {item.title}</p>
                                </div>
                                ...
                                <div className="menu-item-icon flex justify-center items-center aspect-square h-2/3 bg-white overflow-hidden relative z-[3] rounded-md border border-[#614C5C] opacity-0">
                ...
                <div className="header-menu-right w-[50svw] h-full basis-1/2 bg-[#FFCCEA] absolute top-0 right-0 padding-main padding-main-top flex justify-center flex-col">
                    <div className="w-full h-full relative flex flex-col justify-start items-center">
                        ...
                        >close</div>
                        <div className="menu-header-logo opacity-0 w-1/3 h-auto mt-8 aspect-square bg-white rounded-full flex justify-center items-center border-[7px] border-white relative">
                    ...
                    <div className="w-full h-[14.2857142857%] absolute left-0 bottom-0 flex justify-center items-center main-gap">
